DefinitionBlock ("", "SSDT", 2, "T440S", "_BATC", 0x00000000)
{
    ...
    Scope (_SB.PCI0.LPC.EC)
    {
        ...
        Method (GBIF, 3, NotSerialized)
        {
            ...
            If (Arg2)
            {
                ...
                Arg1 [0x0A] = SERN /* \_SB_.PCI0.LPC.EC__.GBIF.SERN */
                HIID = (Arg0 | 0x06)
                ...
                Arg1 [0x0B] = BTYP /* \_SB_.PCI0.LPC.EC__.GBIF.BTYP */
                HIID = (Arg0 | 0x05)
        ...
        Method (RE1B, 1, NotSerialized)
        {
            ...
            Return (BYTE) /* \_SB_.PCI0.LPC.EC__.RE1B.BYTE */
        }
        ...
        Method (RECB, 2, Serialized)
        {
            ...
            Return (TEMP) /* \_SB_.PCI0.LPC.EC__.RECB.TEMP */
        }
